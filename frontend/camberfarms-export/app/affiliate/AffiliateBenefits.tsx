import frameworkIcon from '@/app/assets/icon/framework.svg'
import globeIcon from '@/app/assets/icon/globe.svg'
import leafIcon from '@/app/assets/icon/leaf.svg'
import starIcon from '@/app/assets/icon/star.svg'
import trackIcon from '@/app/assets/icon/track.svg'
