...
import nutsBgImg from '../assets/img/nuts-bg.webp'
...
export default function Hero() {
	return (
		<section className="w-full h-dvh flex flex-col items-center justify-center px-6 py-10 bg-black/70 text-white relative">
			...
			/>
			<div
				className="w-full h-full absolute inset-0 z-1 bg-black/60"
				aria-hidden
			/>
			<div className="w-full sm:w-4/5 md:max-w-3xl flex flex-col items-center justify-center mx-auto mt-10 gap-2 relative z-3">
				<h1 className="font-poppins font-bold text-center text-balance text-3xl md:text-4xl lg:text-[40px] leading-9 md:leading-12">
					Connecting Africa&apos;s Finest Agricultural Products To The World
				</h1>
				<p className="font-inter text-base text-center mt-2 text-light-grey">
					We export high-quality grains, spices, nuts, and other agricultural
					products from trusted African farms to International markets.
					Reliably, sustainably, and on time.
				</p>
				<Link
					href={'/contact-us'}
...
// TODO fix links
// TODO fix background image on desktop
