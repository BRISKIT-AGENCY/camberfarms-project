import locationIcon from '@/app/assets/icon/location-orange-bg.svg'
import mailIcon from '@/app/assets/icon/mail-orange-bg.svg'
import phoneIcon from '@/app/assets/icon/phone-orange-bg.svg'
import timeIcon from '@/app/assets/icon/time-orange-bg.svg'
