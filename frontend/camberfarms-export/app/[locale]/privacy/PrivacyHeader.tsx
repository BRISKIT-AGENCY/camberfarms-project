import patternBg from '@/app/[locale]/assets/img/bg-pattern-white.png'
...
export default async function PrivacyHeader() {
	...
	return (
		<div className="w-full flex items-center justify-center flex-col gap-4 bg-white text-dark-grey p-10 md:p-20 relative lg:mt-20">
			<Image
				src={patternBg}
				fill
				sizes="100vw"
			...
			<div className="w-full flex flex-col gap-4 z-2">
				...
				<p className="text-sm font-inter">{t('lastUpdated')}</p>
				<Link
